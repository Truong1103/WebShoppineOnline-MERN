...
{this.state.hotprods.length > 0 ? (
  <div className="align-center hot-products">
    <img src="hotsale-gia-soc-20-03-gif.gif" alt="Hot Products" className="hot-products-image" />
    {hotprods}
  </div>
) : (
  <div />
...
<div className="khachhang-techzone">
      ...
      >
        <div className="carousel-item">
          <img src="khachhang1.jpeg" alt="khách hàng 1" />
        </div>
        <div className="carousel-item">
          <img src="khachhang2.jpeg" alt="khách hàng 2" />
        </div>
        <div className="carousel-item">
          <img src="khachhang3.jpeg" alt="khách hàng 3" />
        </div>
        <div className="carousel-item">
          <img src="khachhang4.jpeg" alt="khách hàng 4" />
        </div>
        <div className="carousel-item">
          <img src="khachhang5.jpeg" alt="khách hàng 5" />
        </div>
        <div className="carousel-item">
          <img src="khachhang6.jpeg" alt="khách hàng 6" />
        </div>
        <div className="carousel-item">
          <img src="khachhang7.jpeg" alt="khách hàng 7" />
        </div>
        <div className="carousel-item">
          <img src="khachhang8.jpeg" alt="khách hàng 8" />
        </div>
      </Carousel>
    </div>
...
<div class="container-showroom">
    ...
    <div class="showrooms">
        ...
        <ul class="address-list">
            <li><a href="https://www.google.com/maps/search/?api=1&query=69/68+Đặng+Thuỳ+Trâm,+phường+13,+Quận+Bình+Thạnh,+TP.HCM" target="_blank"><i class="fas fa-map-marker-alt"></i> 69/68 Đặng Thuỳ Trâm, phường 13, Quận Bình Thạnh, TP.HCM</a></li>
            <li><a href="https://www.google.com/maps/search/?api=1&query=80/68+Dương+Quảng+Hàm,+phường+5,+Quận+Gò+Vấp,+TP.HCM" target="_blank"><i class="fas fa-map-marker-alt"></i> 80/68 Dương Quảng Hàm, phường 5, Quận Gò Vấp, TP.HCM</a></li>
            <li><a href="https://www.google.com/maps/search/?api=1&query=45+Nguyễn+Khắc+Nhu,+phường+Cô+Giang,+Quận+1,+TP.HCM" target="_blank"><i class="fas fa-map-marker-alt"></i> 45 Nguyễn Khắc Nhu, phường Cô Giang, Quận 1, TP.HCM</a></li>
            <li><a href="https://www.google.com/maps/search/?api=1&query=233A+Phan+Văn+Trị,+phường+11,+Quận+Bình+Thạnh,+TP.HCM" target="_blank"><i class="fas fa-map-marker-alt"></i> 233A Phan Văn Trị, phường 11, Quận Bình Thạnh, TP.HCM</a></li>
            <li><a href="https://www.google.com/maps/search/?api=1&query=160/63AB+Phan+Huy+Ích,+Phường+12,+Quận+Gò+Vấp" target="_blank"><i class="fas fa-map-marker-alt"></i> 160/63AB Phan Huy Ích, Phường 12, Quận Gò Vấp</a></li>
        </ul>
    </div>
</div>  
